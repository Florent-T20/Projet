...
<html lang="en" data-bs-theme="auto">
  <head><script src="../assets/js/color-modes.js"></script>
    ...
    <title>Bergerie des Reptiles</title>
...
<header data-bs-theme="dark">
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand">Bergerie</a>
...
<br /><br />
  ...
  <div class="container marketing">
    ...
    <h1>Bienvenue dans le biome <i>La Bergerie des Reptiles</i></h1>
    ...
    <div class="row featurette">
      ...
      <?php
        ...
        $stmt = $pdo->prepare("SELECT * FROM enclosures WHERE enclosure_id = 50");
        $stmt->execute();
      ...
      <?php
        $stmt = $pdo->prepare("SELECT * FROM animals WHERE enclosure_id = 50");
        $stmt->execute();
